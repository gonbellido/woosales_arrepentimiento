...
class WA_Post_Type
{
    ...
    {
        $labels = [
            'name'               => __('Reclamaciones', 'woosales-arrepentimiento'),
            'singular_name'      => __('Reclamación', 'woosales-arrepentimiento'),
            'menu_name'          => __('Reclamaciones', 'woosales-arrepentimiento'),
            'add_new'            => __('Agregar Nueva', 'woosales-arrepentimiento'),
            'add_new_item'       => __('Nueva Reclamación', 'woosales-arrepentimiento'),
            'edit_item'          => __('Editar Reclamación', 'woosales-arrepentimiento'),
            'view_item'          => __('Ver Reclamación', 'woosales-arrepentimiento'),
            'all_items'          => __('Todas las Reclamaciones', 'woosales-arrepentimiento'),
            'search_items'       => __('Buscar Reclamaciones', 'woosales-arrepentimiento'),
            'not_found'          => __('No se encontraron reclamaciones.', 'woosales-arrepentimiento'),
            'not_found_in_trash' => __('No hay reclamaciones en papelera.', 'woosales-arrepentimiento'),
        ];
    ...
    public function add_metaboxes(): void
    {
        add_meta_box(
            ...
            __('Datos de la Reclamación', 'woosales-arrepentimiento'),
        ...
        add_meta_box(
            ...
            __('Gestión de Estado', 'woosales-arrepentimiento'),
    ...
    public function render_metabox_datos(\WP_Post $post): void
    {
        ...
        <table class="form-table">
            <tr>
                <th><label><?php esc_html_e('Código de Trámite', 'woosales-arrepentimiento'); ?></label></th>
                <td><strong><?php echo esc_html($codigo); ?></strong></td>
            </tr>
            <tr>
                <th><label><?php esc_html_e('Pedido WooCommerce', 'woosales-arrepentimiento'); ?></label></th>
                <td>
                    ...
                    <?php else: ?>
                        ...
                        <?php if ($pedido_id): ?>
                            <em>(<?php esc_html_e('Pedido no encontrado en WooCommerce', 'woosales-arrepentimiento'); ?>)</em>
                        <?php endif; ?>
                    <?php endif; ?>
                </td>
            </tr>
            <tr>
                <th><label><?php esc_html_e('Email Cliente', 'woosales-arrepentimiento'); ?></label></th>
                <td><a href="mailto:<?php echo esc_attr($email); ?>"><?php echo esc_html($email); ?></a></td>
            </tr>
            <tr>
                <th><label><?php esc_html_e('Fecha del Pedido', 'woosales-arrepentimiento'); ?></label></th>
                <td><?php echo esc_html($fecha_pedido); ?></td>
            </tr>
            <tr>
                <th><label><?php esc_html_e('Estado Actual', 'woosales-arrepentimiento'); ?></label></th>
                <td>
            ...
            <tr>
                <th><label><?php esc_html_e('Motivo de Rechazo', 'woosales-arrepentimiento'); ?></label></th>
    ...
    public function render_metabox_gestion(\WP_Post $post): void
    {
        ...
        ?>
        <p>
            <label for="wa_nuevo_estado"><strong><?php esc_html_e('Cambiar a:', 'woosales-arrepentimiento'); ?></strong></label>
            <select name="wa_nuevo_estado" id="wa_nuevo_estado" style="width:100%;margin-top:4px;">
                <option value="">— <?php esc_html_e('Sin cambio', 'woosales-arrepentimiento'); ?> —</option>
        ...
        <p id="wa_motivo_rechazo_wrap" style="display:none;">
            <label for="wa_motivo_rechazo"><strong><?php esc_html_e('Motivo de Rechazo (obligatorio):', 'woosales-arrepentimiento'); ?></strong></label>
            <textarea name="wa_motivo_rechazo" id="wa_motivo_rechazo" rows="3" style="width:100%;margin-top:4px;"></textarea>
        </p>

        <p>
            <label for="wa_nota_interna"><strong><?php esc_html_e('Nota Interna:', 'woosales-arrepentimiento'); ?></strong></label>
            <textarea name="wa_nota_interna" id="wa_nota_interna" rows="2" style="width:100%;margin-top:4px;"></textarea>
        </p>

        <?php if (!empty($log)): ?>
        <hr>
        <p><strong><?php esc_html_e('Historial de cambios:', 'woosales-arrepentimiento'); ?></strong></p>
    ...
    {
        if (!isset($_POST['wa_metabox_nonce']) || !wp_verify_nonce($_POST['wa_metabox_nonce'], 'wa_save_metabox')) {
            return;
        }
