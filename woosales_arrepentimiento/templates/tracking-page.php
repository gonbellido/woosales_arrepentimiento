...
<div class="wa-tracking-wrapper">
    <h2 class="wa-tracking-title"><?php esc_html_e('Seguimiento de Reclamación', 'woosales-arrepentimiento'); ?></h2>
    <p><?php esc_html_e('Ingresá el código de trámite que recibiste por email para consultar el estado de tu reclamación.', 'woosales-arrepentimiento'); ?></p>
    ...
    <form method="get" class="wa-tracking-form">
        <div class="wa-tracking-field">
            <input type="text" name="codigo" value="<?php echo esc_attr($codigo); ?>"
                   placeholder="<?php esc_attr_e('Código de trámite (ej: 847-4521-20260517)', 'woosales-arrepentimiento'); ?>"
                   required>
            <button type="submit" class="wa-btn wa-btn-primary">
                <?php esc_html_e('Consultar', 'woosales-arrepentimiento'); ?>
            </button>
        </div>
    </form>
    ...
    <?php if ($resultado): ?>
        <div class="wa-tracking-result">
            <h3><?php esc_html_e('Detalle de tu Reclamación', 'woosales-arrepentimiento'); ?></h3>

            <div class="wa-result-grid">
                <div class="wa-result-item">
                    <span class="wa-result-label"><?php esc_html_e('Código de Trámite', 'woosales-arrepentimiento'); ?></span>
                    <span class="wa-result-value wa-code"><?php echo esc_html($resultado['codigo']); ?></span>
                </div>

                <div class="wa-result-item">
                    <span class="wa-result-label"><?php esc_html_e('Pedido', 'woosales-arrepentimiento'); ?></span>
                ...
                <div class="wa-result-item wa-result-status">
                    <span class="wa-result-label"><?php esc_html_e('Estado Actual', 'woosales-arrepentimiento'); ?></span>
            ...
            <?php if ($resultado['motivo_rechazo'] && $resultado['estado'] === WA_Status::RECHAZADA): ?>
                <div class="wa-rejection-reason">
                    <h4><?php esc_html_e('Motivo del Rechazo', 'woosales-arrepentimiento'); ?></h4>
            ...
            <?php if (!empty($resultado['log'])): ?>
                <div class="wa-timeline">
                    <h4><?php esc_html_e('Historial de Estados', 'woosales-arrepentimiento'); ?></h4>
                    <ul class="wa-timeline-list">
                        <?php foreach (array_reverse($resultado['log']) as $entry): ?>
                            <li class="wa-timeline-item">
                                <span class="wa-timeline-date"><?php echo esc_html($entry['fecha']); ?></span>
                                ...
                                <?php if (!empty($entry['nota'])): ?>
                                    <span class="wa-timeline-note"><?php echo esc_html($entry['nota']); ?></span>
                                <?php endif; ?>
                            </li>
                        <?php endforeach; ?>
                    </ul>
