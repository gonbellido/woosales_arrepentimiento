...
<div class="wa-tracking-wrapper">
    <h2 class="wa-tracking-title"><?php esc_html_e('Seguimiento de Reclamación', 'boton-de-arrepentimiento-argentina-woosales'); ?></h2>
    <p><?php esc_html_e('Ingresá el código de trámite que recibiste por email para consultar el estado de tu reclamación.', 'boton-de-arrepentimiento-argentina-woosales'); ?></p>
    ...
    <form method="get" class="wa-tracking-form">
        <div class="wa-tracking-field">
            <input type="text" name="codigo" value="<?php echo esc_attr($codigo); ?>"
                   placeholder="<?php esc_attr_e('Código de trámite (ej: 847-4521-20260517)', 'boton-de-arrepentimiento-argentina-woosales'); ?>"
                   required>
            <button type="submit" class="wa-btn wa-btn-primary">
                <?php esc_html_e('Consultar', 'boton-de-arrepentimiento-argentina-woosales'); ?>
            </button>
        </div>
    </form>
    ...
    <?php if ($resultado): ?>
        <div class="wa-tracking-result">
            <h3><?php esc_html_e('Detalle de tu Reclamación', 'boton-de-arrepentimiento-argentina-woosales'); ?></h3>

            <div class="wa-result-grid">
                <div class="wa-result-item">
                    <span class="wa-result-label"><?php esc_html_e('Código de Trámite', 'boton-de-arrepentimiento-argentina-woosales'); ?></span>
                    <span class="wa-result-value wa-code"><?php echo esc_html($resultado['codigo']); ?></span>
                </div>

                <div class="wa-result-item">
                    <span class="wa-result-label"><?php esc_html_e('Pedido', 'boton-de-arrepentimiento-argentina-woosales'); ?></span>
                    <span class="wa-result-value">#<?php echo esc_html($resultado['pedido']); ?></span>
                </div>

                <div class="wa-result-item">
                    <span class="wa-result-label"><?php esc_html_e('Fecha de Solicitud', 'boton-de-arrepentimiento-argentina-woosales'); ?></span>
                    <span class="wa-result-value"><?php echo esc_html($resultado['fecha_creacion']); ?></span>
                </div>

                <div class="wa-result-item wa-result-status">
                    <span class="wa-result-label"><?php esc_html_e('Estado Actual', 'boton-de-arrepentimiento-argentina-woosales'); ?></span>
            ...
            <?php if ($resultado['motivo_rechazo'] && $resultado['estado'] === WA_Status::RECHAZADA): ?>
                <div class="wa-rejection-reason">
                    <h4><?php esc_html_e('Motivo del Rechazo', 'boton-de-arrepentimiento-argentina-woosales'); ?></h4>
            ...
            <?php if (!empty($resultado['log'])): ?>
                <div class="wa-timeline">
                    <h4><?php esc_html_e('Historial de Estados', 'boton-de-arrepentimiento-argentina-woosales'); ?></h4>
