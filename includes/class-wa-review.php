        ...
        <div class="notice notice-info is-dismissible wa-review-notice" style="display:flex;align-items:flex-start;gap:12px;padding:16px;">
            ...
            <div style="flex:1;">
                <p style="font-size:14px;margin:0 0 8px;">
                    <strong><?php esc_html_e('¿Te está sirviendo el Botón de Arrepentimiento Argentina?', 'woosales-arrepentimiento'); ?></strong>
                </p>
                <p style="margin:0 0 12px;">
                    <?php esc_html_e('¡Nos ayudaría mucho que nos dejes una reseña en WordPress.org! Es gratis y lleva 1 minuto. Tu valoración ayuda a mantener el plugin actualizado.', 'woosales-arrepentimiento'); ?>
                </p>
                <p style="margin:0;display:flex;gap:8px;flex-wrap:wrap;">
                    ...
                    <a href="#" class="button" data-wa-dismiss="+30days">
                        <?php esc_html_e('Recordarme en 30 días', 'woosales-arrepentimiento'); ?>
                    </a>
                    <a href="#" class="wa-dismiss-link" data-wa-dismiss="done">
                        <?php esc_html_e('Ya dejé mi reseña ✌️', 'woosales-arrepentimiento'); ?>
                    </a>
                    <a href="#" class="wa-dismiss-link" data-wa-dismiss="never">
                        <?php esc_html_e('No mostrar más', 'woosales-arrepentimiento'); ?>
                    </a>
                </p>
            </div>
        </div>
        ...
        jQuery(function($){
            $('.wa-review-notice [data-wa-dismiss]').on('click', function(e){
                ...
                $.post(ajaxurl, {
                    ...
                    dismiss: value,
                    nonce: '<?php echo wp_create_nonce("wa_review_nonce"); ?>'
                });
